#####################################################################################################################################################
################################ Author: Eldhose Poulose, ACLS, ZHAW ################################################################################
#####################################################################################################################################################
...
# Named list mapping layer names to a coefficient quantifying how much the layer's activation contributes to the loss you'll seek to maximize. 
#Note that the layer names are hardcoded in the built-in Inception V3 application. You can list all layer names using `summary(model)`.
...
step= 0.01 # make more noisy
# Number of scales at which to run gradient ascent
num_octave= 3
# Size ratio between scales
octave_scale= 2.0# as u increase the octave sale it decrease the processing image shape size
...
base_image_path= "Paste here the path to the image"
...
save_img(img, fname= "Paste the path where you want to save your output with file name")
